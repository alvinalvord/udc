...
public abstract class ClinicView extends BorderPane implements View {
	...
	public void update () {
		...
		calendarDayScroller.setViewingId (cvc.selectUserSchedule (viewSelect.getValue ()));
		calendarWeekScroller.setViewingId (cvc.selectUserSchedule (viewSelect.getValue ()));
		agendaWeekScroller.setViewingId (cvc.selectUserSchedule (viewSelect.getValue ()));
		createBox.setViewingId (cvc.selectUserSchedule (viewSelect.getValue ()));
