...
public class DoctorController extends DatabaseControl {
	...
	public void appointmentHandler (int id, String name, String date) {
		...
		popupVbox.setAlignment (Pos.CENTER);
			...
			popupDate = new TextField ();
			popupDate.setText (date);
			popupDate.setId ("TextField");
			popupDate.setAlignment (Pos.CENTER_LEFT);
		...
		popupVbox.getChildren ().addAll (appointmentPopup, popupDate, popupTimeHBox, popupButtonHBox);
		...
		save.setOnAction (mouseAction -> {
			createUpdate(id, popupDate.getText(), popupFrom.getValue(), popupTo.getValue());
			popup.close();
		});
