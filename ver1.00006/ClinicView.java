...
public abstract class ClinicView extends BorderPane implements View {
	...
	protected void initRightPane () {
		...
		calendarDayScroller = new CalendarDayScroller (dc, gcm);
		calendarWeekScroller = new CalendarWeekScroller (dc, gcm);
		agendaDayScroller = new AgendaDayScroller (dc, gcm);
		agendaWeekScroller = new AgendaWeekScroller (dc, gcm);
